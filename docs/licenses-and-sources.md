...
2026-09-25 추가 확인: [6단계 출처·variant 준비 표](phase6-data-readiness.md)에 UCI Electricity/AQShunyi와 MPI Weather의 CC BY 4.0 원본, 저자 배포 행렬과 미확정 항목을 기록했습니다. 아래 2026-09-20 기록은 당시 상태이며, 기존 bundle 차단은 유지합니다.
